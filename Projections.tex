...
Since $\tilde A$ does not contain closed geodesics, it is CAT(1), by  the generalized Hadamard--Cartan theorem, \cite[8.13.3]{AKP}, \cite[6.8+6.9]{ballmannnotes}, \cite{bowditch}.
