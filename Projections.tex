...
In this example, all subsets $C_i$ are isometric to the unit interval, the projections $P_i$ maps all of these segments isometrically onto $C_1$ and the composition $P\z=P_1\circ P_2\circ P_3$ is maps $C_1$ to itself isometrically but exchanges the endpoints.
...
Denote by $E$ the inverse image of the geodesic in $\tilde A$.
