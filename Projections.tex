...
produces M\"obius band $B$ divided into three rectangles and a map from $B$ to a  Hadamard space that is distance-preserving on each rectangle.
...
Then the cyclic product of these projection is the rotation of a disc by the prescribed twisting angle $\alpha$.
