...
Each set $C_i$ will be  isometric to a small Euclidean disc and the composition $P\:C_1\z\to C_1$ will rotate the disc by a given angle $\alpha$.
...
By construction, $Z$ is a locally convex subset of $X$. Hence, $Z$ a convex subset of~$X$ \cite[2.2.12]{AKP_inv}.
