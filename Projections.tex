...
Namely, we construct an example of Hadamard spaces with convex sets such that their  is not asymptotically regular.
...
As it was pointed out by an anonymous referee, the following statement follows from \cite[Theorem 3.3]{asymptotic}.
...
Let us also thank the anonymous referees for thoughtful reading and useful suggestions.
...
Note that boundary of $A$ is a saddle surface in $\mathbb{S}^3$.
Therefore, by the result of Stephanie Alexander,  David Berg, and Richard Bishop \cite {ABB-1993}, $A$ inherits the upper curvature bound from $\mathbb{S}^3$; that is, $A$ is locally CAT(1).
